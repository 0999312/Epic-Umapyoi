...
public class BedrockModelTransformer extends HumanoidModelTransformer {
	...
	public static AnimatedMesh bakeMeshFromCubes(List<BedrockModelPartition> partitions) {
		...
		for (BedrockModelPartition modelpartition : partitions) {
	...
	private static void bake(PoseStack poseStack, String partName, BedrockModelPartition modelpartition, BedrockPart part, List<SingleGroupVertexBuilder> vertices, Map<MeshPartDefinition, IntList> indices, List<String> path, PartTransformer.IndexCounter indexCounter, boolean bindPart) {
	...
	@OnlyIn(Dist.CLIENT)
	private static class SimpleTransformer extends PartTransformer<BedrockCube> {
		...
		public void bakeCube(PoseStack poseStack, MeshPartDefinition partDefinition, BedrockCube cube, List<SingleGroupVertexBuilder> vertices, Map<MeshPartDefinition, IntList> indices, IndexCounter indexCounter) {
			for (BedrockPolygon quad : cube.getPolygons()) {
				...
				PartTransformerInvoker.invokeTriangluatePolygon(indices, partDefinition, indexCounter);
			}
		}
	...
	@OnlyIn(Dist.CLIENT)
	private static class ChestPartTransformer extends PartTransformer<BedrockCube> {
		private static final float X_PLANE = 0.0F;
		private static final VertexWeight[] WEIGHT_ALONG_Y = { new VertexWeight(13.6666F, 0.230F, 0.770F), new VertexWeight(15.8333F, 0.254F, 0.746F), new VertexWeight(18.0F, 0.5F, 0.5F), new VertexWeight(20.1666F, 0.744F, 0.256F), new VertexWeight(22.3333F, 0.770F, 0.230F)};
		private final SimpleTransformer upperAttachmentTransformer;
		private final SimpleTransformer lowerAttachmentTransformer;
		private final AABB noneAttachmentArea;
		private final float yClipCoord;
		...
		public static List<VertexWeight> getMiddleYClipWeights(float minY, float maxY) {
	...
	@OnlyIn(Dist.CLIENT)
	public static class LimbPartTransformer extends PartTransformer<BedrockCube> {
		public final int upperJoint;
		public final int lowerJoint;
		public final int middleJoint;
		public final boolean bendInFront;
		public final SimpleTransformer upperAttachmentTransformer;
		public final SimpleTransformer lowerAttachmentTransformer;
		public final AABB noneAttachmentArea;
		public final float yClipCoord;
	...
	private static Direction getDirectionFromVector(Vector3f directionVec) {
	...
	@OnlyIn(Dist.CLIENT)
	public record BedrockPartDefinition(String partName, List<String> path, OpenMatrix4f invertedParentTransform, BedrockPart root) implements MeshPartDefinition {
		public static MeshPartDefinition of(String partName) {
			return new BedrockPartDefinition(partName, null, null, null);
		}
		...
		public static MeshPartDefinition of(String partName, List<String> path, OpenMatrix4f invertedParentTransform, BedrockPart root) {
			return new BedrockPartDefinition(partName, path, invertedParentTransform, root);
		}
